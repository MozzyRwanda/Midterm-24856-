...
public class CreateTableWithReference {
    ...
    private static final String URL ="jdbc:mysql://localhost:3306/aucaweb?serverTimezone=UTC";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String createstudentusers = "CREATE TABLE IF NOT EXISTS users ("
                    + "id INT AUTO_INCREMENT PRIMARY KEY,"
                    + "email VARCHAR(255),"
            ...
            statement.executeUpdate(createstudentusers);
